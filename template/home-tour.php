<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/home-tour.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:30:32 GMT -->
                            ...
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Tours</a>
                                        <ul class="sub-menu">
                                            <li class="current-menu-item"><a href="home-tour.php" title="">Tours</a></li>
                ...
                <div class="banner-cn">
                    ...
                    <div class="category-singer clearfix">
                        <div class="cate-singer-icon float-left">
                            <h2>Tour</h2><img src="images/icon-vacation.png" alt=""></div>
            ...
            <div class="title-wrap">
                <div class="container">
                    <div class="travel-title float-left">
                        <h2>Deals of the week:<span>Paris, Amsterdam, Saint Petersburg &amp; more</span></h2></div>
                </div>
            </div>
            <div class="container">
                <div class="cruise-deals-cn clearfix">
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.php" title=""><img src="images/deal/img-5.jpg" alt=""></a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="tour-detail.php" title="">Amsterdam</a></div>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.php" title=""><img src="images/deal/img-6.jpg" alt=""></a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="tour-detail.php" title="">HongKong</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$175</span></div>
                            </div>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.php" title=""><img src="images/deal/img-7.jpg" alt=""></a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="tour-detail.php" title="">Barcelona</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$175</span></div>
                            </div>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.php" title=""><img src="images/deal/img-8.jpg" alt=""></a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="tour-detail.php" title="">Bangkok</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$175</span></div>
                            </div>
