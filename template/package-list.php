<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/package-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:30:15 GMT -->
                        ...
                        <div class="tb">
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Package</a>
                                        <ul class="sub-menu">
                                            <li><a href="home-package.html" title="">Package Deals</a></li>
                                            <li class="current-menu-item"><a href="package-list.html">Package Deals List</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="col-md-9 col-md-push-3">
                            ...
                            <section class="package-list">
                                <ul class="payment-step package-step text-center clearfix">
                                    <li class="step-part"><span><img src="images/icon-step-hotel.png" alt=""></span>
                                        <p>Choosing hotel</p>
                                    </li>
                                    <li><span><img src="images/icon-step-bed.png" alt=""></span>
                                        <p>Selecting room</p>
                                    </li>
                                    <li><span><img src="images/icon-step-flight.png" alt=""></span>
                                ...
                                <div class="sort-view clearfix">
                                    <div class="sort-by float-left">
                                        <label>Sort by:</label>
                                        <div class="sort-select select float-left"><span>Star rating</span>
                                            <select>
                                        ...
                                        <div class="sort-select select float-left"><span>Guest rating</span>
                                            <select>
                                        ...
                                        <div class="sort-select select float-left"><span>Pricing</span>
                                            <select name="pricing">
                                ...
                                <div class="package-list-cn">
                                    <div class="package-item">
                                        <figure class="package-img">
                                            <a href="#"><img src="images/package/img-1.jpg" alt=""></a>
                                        </figure>
                                        <div class="package-text">
                                            <div class="package-name"><a href="#">Copley Square</a></div><span class="package-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></span> <span class="package-rating"><ins>7.5</ins> - Good</span><address class="package-address">42 Princes Square, London W2 4AD</address>
                                            <p>My stay at cumberland hotel was amazing, loved the location, was close to all the major attractions allt... <a href="#">view all 125 reviews</a></p>
                                            <div class="price-box"><span class="price separately">Booked separately<br><ins>$4250</ins></span> <span class="price together">Booked together<br><ins>$1,757</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                                    <div class="package-item">
                                        <figure class="package-img">
                                            <a href="#"><img src="images/package/img-2.jpg" alt=""></a>
                                        </figure>
                                        <div class="package-text">
                                            <div class="package-name"><a href="#">The Cosmopolitan</a></div><span class="package-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></span> <span class="package-rating"><ins>7.5</ins> - Good</span><address class="package-address">42 Princes Square, London W2 4AD</address>
                                            <p>My stay at cumberland hotel was amazing, loved the location, was close to all the major attractions allt... <a href="#">view all 125 reviews</a></p>
                                            <div class="price-box"><span class="price separately">Booked separately<br><ins>$4250</ins></span> <span class="price together">Booked together<br><ins>$1,757</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                                    <div class="package-item">
                                        <figure class="package-img">
                                            <a href="#"><img src="images/package/img-3.jpg" alt=""></a>
                                        </figure>
                                        <div class="package-text">
                                            <div class="package-name"><a href="#">Melia White House Hotel</a></div><span class="package-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></span> <span class="package-rating"><ins>7.5</ins> - Good</span><address class="package-address">42 Princes Square, London W2 4AD</address>
                                            <p>My stay at cumberland hotel was amazing, loved the location, was close to all the major attractions allt... <a href="#">view all 125 reviews</a></p>
                                            <div class="price-box"><span class="price separately">Booked separately<br><ins>$4250</ins></span> <span class="price together">Booked together<br><ins>$1,757</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                                    <div class="package-item">
                                        <figure class="package-img">
                                            <a href="#"><img src="images/package/img-4.jpg" alt=""></a>
                                        </figure>
                                        <div class="package-text">
                                            <div class="package-name"><a href="#">Kensington Close Hotel</a></div><span class="package-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></span> <span class="package-rating"><ins>7.5</ins> - Good</span><address class="package-address">42 Princes Square, London W2 4AD</address>
                                            <p>My stay at cumberland hotel was amazing, loved the location, was close to all the major attractions allt... <a href="#">view all 125 reviews</a></p>
                                            <div class="price-box"><span class="price separately">Booked separately<br><ins>$4250</ins></span> <span class="price together">Booked together<br><ins>$1,757</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                            ...
                            <div class="sidebar-cn">
                                    ...
                                    <div class="row">
                                        <div class="form-search clearfix">
                                            ...
                                            <div class="form-field field-select col-md-6">
                                                <div class="select"><span data-placeholder="Select">2 guest</span>
                                                    <select>
                                                        <option value="1">1 guest</option>
                                                        <option selected="selected" value="1">2 guest</option>
                                ...
                                <div class="widget-sidebar start-rating-sidebar">
                                    ...
                                    <ul class="widget-rate">
                                        <li>
                                            ...
                                            <div class="group-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></div>5 Stars <span>12</span></li>
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="rating-4" type="checkbox" class="checkbox">
                                                <label for="rating-4"></label>
                                            </div>
                                            <div class="group-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></div>4 Stars <span>12</span></li>
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="rating-3" type="checkbox" class="checkbox">
                                                <label for="rating-3"></label>
                                            </div>
                                            <div class="group-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></div>3 Stars <span>12</span></li>
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="rating-2" type="checkbox" class="checkbox">
                                                <label for="rating-2"></label>
                                            </div>
                                            <div class="group-star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></div>2 Stars <span>12</span></li>
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="rating-1" type="checkbox" class="checkbox">
                                                <label for="rating-1"></label>
                                            </div>
                                            <div class="group-star"><i class="glyphicon glyphicon-star"></i></div>1 Stars <span>12</span></li>
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="rating-6" type="checkbox" class="checkbox">
                                                <label for="rating-6"></label>
                                            </div>
                                            <div class="group-star"><i class="glyphicon glyphicon-star-empty"></i></div>Not Rated <span>12</span></li>
                                    </ul>
                                </div>
                                ...
                                <div class="widget-sidebar facilities-sidebar">
                                    ...
                                    <ul class="widget-ul">
                                        ...
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="checkbox-2" type="checkbox" class="checkbox" checked="checked">
                                ...
                                <div class="widget-sidebar area-sidebar">
                                    ...
                                    <ul class="widget-ul">
                                        ...
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="area-2" type="checkbox" class="checkbox" checked="checked">
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/package-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:30:20 GMT -->
