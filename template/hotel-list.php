<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/hotel-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:27 GMT -->
                                ...
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Hotel</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current-menu-item"><a href="hotel-list.php">Hotel List 1</a></li>
                            ...
                            <section class="hotel-list">
                                <div class="sort-view clearfix">
                                    ...
                                    <div class="view-by float-right">
                                        <ul>
                                            <li>
                                                <a href="hotel-list.php" title="" class="current"><img src="images/icon-grid.png" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="hotel-list-2.php" title=""><img src="images/icon-list.png" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="hotel-maps.php" title=""><img src="images/icon-map.png" alt=""></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="hotel-grid-cn clearfix">
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.php" title="">Copley Square Hotel</a></div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.php" title="">Grand Hotel Bagni Nuovi</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.php" title="">Melia White House Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.php" title="">A Hidden NYC Mystery Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.php" title="">Town Hall Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/hotel-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:29 GMT -->
