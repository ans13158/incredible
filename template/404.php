...
<html class="" lang="en">
<!--<![endif]-->
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:25 GMT -->
            ...
            <div class="container">
                ...
                <div class="page-body text-center">
                    <div class="item-content">
                        <div class="image-wrap"><img src="images/404.png" alt=""></div>
                        <h4>We’re really sorry!</h4>
                        <p>Something went wrong trying to display the page,
                            <br>Please try one of these instead</p>
                    </div>
                    <div class="item-footer"><a href="#" class="awe-btn awe-btn-5 arrow-right awe-btn-small text-uppercase">GO home</a> <a href="#" class="awe-btn awe-btn-5 arrow-right awe-btn-small text-uppercase">GO previous page</a></div>
                </div>
            </div>
        </section>
        <footer>
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:26 GMT -->
