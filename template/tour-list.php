<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/tour-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:30:32 GMT -->
                                ...
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Tours</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current-menu-item"><a href="tour-list.php">Tour List</a></li>
                                ...
                                <div class="cruise-list-cn tour-list-cn">
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-6.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">European Contrasts plus Corfu</a></div>
                                            <ul class="ship-port">
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-7.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">Winter Wanderer</a></div>
                                            <ul class="ship-port">
                                                <li><span class="label">Featuring:</span> France, Switzerland, Spain, Monaco, Italy, Vatican City, Austria, Germany, Czech Republic, Netherlands, Belgium (in transit)</li>
                                            </ul>
                                            <div class="price-box"><span class="price">From<br><ins>$429</ins></span> <span class="price night"><ins>6</ins><small>/day</small></span></div>
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-8.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">Berlin &amp; Prague plus Vienna</a></div>
                                            <ul class="ship-port">
                                                <li><span class="label">Featuring:</span> France, Switzerland, Spain, Monaco, Italy, Vatican City, Austria, Germany, Czech Republic, Netherlands, Belgium (in transit)</li>
                                            </ul>
                                            <div class="price-box"><span class="price">From<br><ins>$429</ins></span> <span class="price night"><ins>6</ins><small>/day</small></span></div>
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-9.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">European Contrasts plus Corfu</a></div>
                                            <ul class="ship-port">
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-10.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">European Inspiration</a></div>
                                            <ul class="ship-port">
                                                <li><span class="label">Featuring:</span> France, Switzerland, Spain, Monaco, Italy, Vatican City, Austria, Germany, Czech Republic, Netherlands, Belgium (in transit)</li>
                                            </ul>
                                            <div class="price-box"><span class="price">From<br><ins>$429</ins></span> <span class="price night"><ins>6</ins><small>/day</small></span></div>
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-11.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">Winter Wanderer</a></div>
                                            <ul class="ship-port">
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-12.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">Berlin &amp; Prague plus Vienna</a></div>
                                            <ul class="ship-port">
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-13.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">European Contrasts plus Corfu</a></div>
                                            <ul class="ship-port">
                                    ...
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                            <a href="tour-detail.php"><img src="images/tour/img-14.jpg" alt=""></a>
                                        </figure>
                                        <div class="cruise-text">
                                            <div class="cruise-name"><a href="tour-detail.php">European Inspiration</a></div>
                                            <ul class="ship-port">
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/tour-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:30:48 GMT -->
