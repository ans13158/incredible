...
<body>
                ...
                <div class="main-cn bg-white clearfix">
                    ...
                    <section class="contact-page">
                        ...
                        <div class="contact-cn">
                            ...
                            <ul>
                                <li><img src="images/icon-maker-contact.png" alt=""> 25 California Avenue, Santa Monica, California.</li>
                                <li><img src="images/icon-phone.png" alt=""> +1-888-8765-1234</li>
                                <li><img src="images/icon-email.png" alt=""> <a href="#">contact@bookatrip.com</a></li>
                            </ul>
    ...
    <script type="text/javascript" src="js/library/jquery.form.min.js"></script>
