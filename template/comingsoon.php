...
<html class="" lang="en">
<!--<![endif]-->
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/comingsoon.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:26 GMT -->
...
<body>
    ...
    <div id="wrap">
        <header id="header" class="header">
            <div class="container">
                ...
                <nav class="navigation nav-c" id="navigation" data-menu-type="4000">
                                ...
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#">Pages</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current-menu-item"><a href="comingsoon.php" title="">Comingsoon</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="container">
                ...
                <div class="page-body text-center">
                    <div class="item-content">
                        <div class="image-wrap"><img src="images/comingsoon.png" alt=""></div>
    ...
    <script type="text/javascript" src="js/library/jquery.countdown.min.js"></script>
    <script type="text/javascript">
        var nextYear = new Date(new Date().getFullYear() + 1, 1 - 1, 26);
        $('#countdown').countdown(nextYear, function(event) {
            var $this = $(this).php(event.strftime('' + '<div class="item"><span class="count">%D</span><span>Days</span></div>' + '<div class="item"><span class="count">%H</span><span>Hours</span></div>' + '<div class="item"><span class="count">%M</span><span>Minutes</span></div>' + '<div class="item"><span class="count">%S</span><span>Seconds</span></div>'));
        });
    </script>
</body>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/comingsoon.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:27 GMT -->
