<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:26:11 GMT -->
                            ...
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#">Pages</a>
                                        <ul class="sub-menu">
                                            <li class="current-menu-item"><a href="#" title="">Blog</a>
                                                <ul class="sub-menu">
                                                    <li><a href="blog.html" title="">Blog</a></li>
                                                    <li class="current-menu-item"><a href="blog-detail.html">Blog Detail</a></li>
                                                </ul>
                                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-9 col-md-push-3">
                                <div class="post post-single">
                                    <div class="author-date"><a href="#">Admin</a> <small>///</small> <span>Jun, 7, 2014</span></div>
                                    <h1 class="title-post-head">Thailand by Train with Eastern and Oriental Express</h1>
                                    <div class="post-media">
                                        <div class="image-wrap"><img src="images/blog/img-1.jpg" alt=""></div>
                                    </div>
                                    <div class="post-content">
                                        ...
                                        <p class="wp-caption alignleft"><img src="images/blog/img-2.jpg" alt=""></p>
                                    ...
                                    <div class="post-meta-share">
                                        ...
                                        <div class="post-share float-right"><a href="#" title=""><i class="fa fa-facebook"></i></a> <a href="#" title=""><i class="fa fa-twitter"></i></a> <a href="#" title=""><i class="fa fa-google-plus"></i></a></div>
                                    </div>
                                    <div class="author-about">
                                        <h4>About author</h4>
                                        <div class="image float-left"><img src="images/blog/user/img-1.jpg" alt=""></div>
                                        <div class="author-info">
                                            <h5>John Doe</h5>
                                            <div class="author-social"><a href="#"><i class="fa fa-wordpress"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a></div>
                                            <p>The idea of Meks came to us after hours and hours of constant work. We want to make contribution to the world by producing finest and smartest stuff for the web. Look better, run faster, feel better, become better!</p>
                                        </div>
                                    </div>
                                    <div id="comments">
                                        ...
                                        <ul class="commentlist">
                                            <li class="comment">
                                                <div class="comment-author"><img src="images/blog/user/img-2.jpg" alt=""></div>
                                                <div class="comment-body"><cite class="fn"><a href="#">Donec Nibh</a></cite> <small>3 days ago</small>
                                                    <p>Vestibulum a nisl ipsum. Curabitur aliquet nec felis quis convallis. Quisque et auctor dui, id adipiscing nunc. Etiam et dui lobortis, volutpat justo ac, tempor lorem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus purus nisi, porttitor ac adipiscing ac, cursus eu massa.</p><span class="edit"><a href="#"><i class="fa fa-edit"></i> Edit</a> | <a href="#"><i class="fa fa-reply"></i> Reply</a></span></div>
                                                <ul class="children">
                                                    <li class="comment">
                                                        <div class="comment-author"><img src="images/blog/user/img-1.jpg" alt=""></div>
                                                        <div class="comment-body"><cite class="fn"><a href="#">Donec Nibh</a></cite> <small>3 days ago</small>
                                                            <p>Vestibulum a nisl ipsum. Curabitur aliquet nec felis quis convallis. Quisque et auctor dui, id adipiscing nunc. Etiam et dui lobortis, volutpat justo ac, tempor lorem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus purus nisi, porttitor ac adipiscing ac, cursus eu massa.</p><span class="edit"><a href="#"><i class="fa fa-edit"></i> Edit</a> | <a href="#"><i class="fa fa-reply"></i> Reply</a></span></div>
                                                    </li>
                                                </ul>
                                            ...
                                            <li class="comment">
                                                <div class="comment-author"><img src="images/blog/user/img-3.jpg" alt=""></div>
                                                <div class="comment-body"><cite class="fn"><a href="#">Donec Nibh</a></cite> <small>3 days ago</small>
                                                    <p>Vestibulum a nisl ipsum. Curabitur aliquet nec felis quis convallis. Quisque et auctor dui, id adipiscing nunc. Etiam et dui lobortis, volutpat justo ac, tempor lorem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus purus nisi, porttitor ac adipiscing ac, cursus eu massa.</p><span class="edit"><a href="#"><i class="fa fa-edit"></i> Edit</a> | <a href="#"><i class="fa fa-reply"></i> Reply</a></span></div>
                                            </li>
                                            <li class="comment">
                                                <div class="comment-author"><img src="images/blog/user/img-4.jpg" alt=""></div>
                                                <div class="comment-body"><cite class="fn"><a href="#">Donec Nibh</a></cite> <small>3 days ago</small>
                                                    <p>Vestibulum a nisl ipsum. Curabitur aliquet nec felis quis convallis. Quisque et auctor dui, id adipiscing nunc. Etiam et dui lobortis, volutpat justo ac, tempor lorem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus purus nisi, porttitor ac adipiscing ac, cursus eu massa.</p><span class="edit"><a href="#"><i class="fa fa-edit"></i> Edit</a> | <a href="#"><i class="fa fa-reply"></i> Reply</a></span></div>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-md-3 col-md-pull-9">
                                ...
                                <div class="widget widget_tag_cloud">
                                    ...
                                    <div class="tagcloud"><a href="#">Branding</a> <a href="#">Justo</a> <a href="#">Consectetur</a> <a href="#">tristique tempus</a> <a href="#">Music</a> <a href="#">Lasvegas Vedana</a></div>
                                </div>
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:26:17 GMT -->
