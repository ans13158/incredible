<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/home-package.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:30:15 GMT -->
                            ...
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Package</a>
                                        <ul class="sub-menu">
                                            <li class="current-menu-item"><a href="home-package.html" title="">Package Deals</a></li>
                ...
                <div class="banner-cn">
                    ...
                    <div class="category-singer clearfix">
                        <div class="cate-singer-icon float-left">
                            <h2>Packge Deals</h2><img src="images/icon-tour.png" alt=""></div>
            ...
            <div class="title-wrap">
                <div class="container">
                    <div class="travel-title float-left">
                        <h2>Top vacation package deals:</h2><span class="span-departure">Choose your departure</span>
                        <div class="select"><span>Las Vegas - Nevada</span>
                    ...
                    </div><a href="#" title="" class="awe-btn awe-btn-5 arrow-right awe-btn-lager text-uppercase float-right">ALL SALES</a></div>
            </div>
            <div class="container">
                <div class="cruise-deals-cn clearfix">
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">Los Angeles</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$44</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">Fort Lauderdale</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$345</del></span> <span class="price special-price">$65</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">Seattle</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$80</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">Atlanta</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$93</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                ...
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$95</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">Las Vegas</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="#" title=""><img src="images/deal/img-7.jpg" alt=""></a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">San Francisco</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$134</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            ...
                            <div class="cruise-text">
                                <div class="cruise-name"><a href="#" title="">Orlando</a></div>
                                <div class="cruise-night"><span>9 nights</span> - 05/12 - 12/14</div>
                                <hr class="hr">
                                <div class="price-box"><span class="price old-price">Only <del>$269</del></span> <span class="price special-price">$137</span></div>
                            </div>
                        </div>
                    </div>
                </div>
