<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/user-review.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:18 GMT -->
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current-menu-parent"><a href="#" title="">User</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="current-menu-item"><a href="user-review.html" title="">User Review</a></li>
                ...
                <div class="main-cn element-page bg-white clearfix">
                    ...
                    <section class="user-profile">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <h2 class="user-profile__title">My Reviews</h2>
                                <div class="user-review">
                                    <div class="row review-item">
                                        <div class="col-xs-12">
                                            <div class="review-header"><span class="date">3/2/ 2014</span>
                                                <h4>Grand Plaza Serviced Apartments <span class="star"><i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i> <i class="glyphicon glyphicon-star"></i></span></h4><a href="#" class="btn">See detail</a></div>
                                        </div>
                                        <div class="col-xs-3 review-number"><ins>5.6</ins></div>
                                    ...
                                    <div class="row review-item">
                                        ...
                                        <div class="col-xs-3 review-number"><ins>9.0</ins></div>
                                        <div class="col-xs-9 review-text">
                                            <ul>
                                                <li><span class="icon fa fa-plus"></span>Location, warmth, cleanliness</li>
                                            </ul>
