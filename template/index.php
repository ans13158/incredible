        ...
        <header id="header" class="header">
            <div class="container">
                <div class="logo float-left">
                    <a href="index.php" title=""><img src="images/logo-header.png" alt=""></a>
                </div>
                        ...
                        <div class="tb">
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    <li class="current-menu-parent"><a href="index.php" title="">Home</a>
                                        <ul class="sub-menu">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="logo-foter">
                            <a href="index.php" title=""><img src="images/logo-footer.png" alt=""></a>
                        </div>
                    </div>
