                            ...
                            <section class="cruise-list">
                                <div class="sort-view clearfix">
                                    <div class="sort-by float-left">
                                        <label>Sort by:</label>
                                        <div class="sort-select select float-left"><span>Travelocity Picks</span>
                                            <select>
                                ...
                                <div class="cruise-list-cn">
                                    <div class="cruise-item">
                                        ...
                                        <div class="cruise-text">
                                            ...
                                            <div class="price-box"><span class="price">From<br><ins>$429</ins></span> <span class="price night"><ins>$61</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                        ...
                                        <div class="cruise-text">
                                            ...
                                            <div class="price-box"><span class="price">From<br><ins>$356</ins></span> <span class="price night"><ins>$61</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                    ...
                                    <div class="cruise-item">
                                        ...
                                        <div class="cruise-text">
                                            ...
                                            <div class="price-box"><span class="price">From<br><ins>$250</ins></span> <span class="price night"><ins>$61</ins><small>/night</small></span></div>
                                        </div>
                                    </div>
                                    <div class="cruise-item">
                                        <figure class="cruise-img">
                                ...
                                <div class="search-sidebar">
                                    ...
                                    <div class="row">
                                        <div class="form-search clearfix">
                                            ...
                                            <div class="form-field field-select col-md-12">
                                                <div class="select"><span data-placeholder="Select">Cruise Line</span>
                                                    <select name="guest">
