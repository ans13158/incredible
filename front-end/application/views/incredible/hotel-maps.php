<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/hotel-maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:33 GMT -->
...
<body>
    ...
    <div id="wrap">
                                ...
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Hotel</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current-menu-item"><a href="hotel-maps.html">Hotel Map</a></li>
        ...
        <div class="main">
            <div class="container">
                <div class="main-cn hotel-maps bg-white clearfix">
                    <div class="row">
                        <div class="col-md-9 col-md-push-3">
                            ...
                            <div class="sort-view clearfix">
                                ...
                                <div class="view-by float-right">
                                    <ul>
                                        <li>
                                            <a href="hotel-list.html" title=""><img src="images/icon-grid.png" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="hotel-list-2.html" title=""><img src="images/icon-list.png" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="hotel-maps.html" title="" class="current"><img src="images/icon-map.png" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
