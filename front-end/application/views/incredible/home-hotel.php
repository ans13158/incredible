<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/home-hotel.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:27 GMT -->
                            ...
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Hotel</a>
                                        <ul class="sub-menu">
                                            <li class="current-menu-item"><a href="home-hotel.html" title="">Hotel</a></li>
            ...
            <div class="container">
                <div class="banner-cn">
                    <ul class="tabs-cat text-center row">
                        <li class="cate-item col-xs-2"><a data-toggle="tab" href="#form-flight" title=""><span>flight</span> <img src="images/icon-flight.png" alt=""></a></li>
                        <li class="cate-item active col-xs-2"><a data-toggle="tab" href="#form-hotel" title=""><span>Hotel</span><img src="images/icon-hotel.png" alt=""></a></li>
                        <li class="cate-item col-xs-2"><a data-toggle="tab" href="#form-car" title=""><span>Car</span><img src="images/icon-car.png" alt=""></a></li>
                        <li class="cate-item col-xs-2"><a data-toggle="tab" href="#form-package" title=""><span>package deals</span><img src="images/icon-tour.png" alt=""></a></li>
                        <li class="cate-item col-xs-2"><a data-toggle="tab" href="#form-cruise" title=""><span>cruise</span><img src="images/icon-cruise.png" alt=""></a></li>
                        <li class="cate-item col-xs-2"><a data-toggle="tab" href="#form-tour" title=""><span>TOUR</span><img src="images/icon-vacation.png" alt=""></a></li>
                    </ul>
            ...
            <div class="title-wrap">
                <div class="container">
                    <div class="travel-title float-left">
                        <h2>Hot Sale Today: <span>Paris, Amsterdam, Saint Petersburg &amp; more</span></h2></div><a href="#" title="" class="awe-btn awe-btn-5 arrow-right awe-btn-lager text-uppercase float-right">ALL SALES</a></div>
            </div>
            <div class="container">
                <div class="sales-cn">
                    <div class="row">
                        <div class="col-xs-6 col-md-3">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="hotel-detail.html" title=""><img src="images/deal/img-1.jpg" alt=""></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places">
                                        <div class="home-sales-name"><a href="hotel-detail.html" title="">Copley Square Hotel</a></div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="hotel-detail.html" title=""><img src="images/deal/img-2.jpg" alt=""></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places">
                                        <div class="home-sales-name"><a href="hotel-detail.html" title="">Grand Hotel Bagni Nuovi</a></div>
                        ...
                        <div class="col-md-6">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="hotel-detail.html" title=""><img src="images/deal/img-3.jpg" alt=""></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places">
                                        <div class="home-sales-name"><a href="hotel-detail.html" title="">The Standard, East Village</a></div>
                        ...
                        <div class="col-md-6">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="hotel-detail.html" title=""><img src="images/deal/img-4.jpg" alt=""></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places">
                                        <div class="home-sales-name"><a href="hotel-detail.html" title="">Ganges River Cruise</a></div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="hotel-detail.html" title=""><img src="images/deal/img-5.jpg" alt=""></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places">
                                        <div class="home-sales-name"><a href="hotel-detail.html" title="">Town Hall Hotel</a></div>
                                        <div class="home-sales-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                    </div>
                                    <hr class="hr">
                                    <div class="price-box"><span class="price old-price">From <del>$269</del></span> <span class="price special-price">$175<small>/night</small></span></div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="hotel-detail.html" title=""><img src="images/deal/img-6.jpg" alt=""></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places">
                                        <div class="home-sales-name"><a href="hotel-detail.html" title="">A Hidden NYC Mystery Hotel</a></div>
                                        <div class="home-sales-places"><a href="#" title="">Boston</a>, <a href="#" title="">Italy</a></div>
                                    </div>
                                    <hr class="hr">
                                ...
                                <div id="owl-magazine-ds">
                                    <div class="magazine-item">
                                        ...
                                        <div class="magazine-footer clearfix">
                                            <div class="post-share magazine-share float-left"><a href="#" title=""><i class="fa fa-facebook"></i></a> <a href="#" title=""><i class="fa fa-twitter"></i></a> <a href="#" title=""><i class="fa fa-google-plus"></i></a></div><a href="#" title="" class="awe-btn awe-btn-6 awe-btn-lager text-uppercase float-right">view more</a></div>
                                    </div>
                                    <div class="magazine-item">
                                        <div class="magazine-header">
                                            <h2>Five festivals to look forward to this year</h2>
                        ...
                        <div class="col-lg-6">
                            <div class="magazine-thum" id="magazine-thum">
                                <div class="thumnail-item active clearfix">
                                    <figure class="float-left"><img src="images/magazine/img-1.jpg" alt=""></figure>
                                ...
                                <div class="thumnail-item clearfix">
                                    <figure class="float-left"><img src="images/magazine/img-2.jpg" alt=""></figure>
                                    <div class="thumnail-text">
                                        <h4>Thailand by Train with Eastern and Oriental Express</h4><span>03.5.2014</span></div>
                                </div>
                                <div class="thumnail-item clearfix">
                                    <figure class="float-left"><img src="images/magazine/img-3.jpg" alt=""></figure>
                                    <div class="thumnail-text">
                                        <h4>Thailand by Train with Eastern and Oriental Express</h4><span>03.5.2014</span></div>
                                </div>
                                <div class="thumnail-item clearfix">
                                    <figure class="float-left"><img src="images/magazine/img-4.jpg" alt=""></figure>
                                    <div class="thumnail-text">
                                        <h4>Thailand by Train with Eastern and Oriental Express</h4><span>03.5.2014</span></div>
                                </div>
                            </div>
