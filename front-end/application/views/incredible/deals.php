                ...
                <div class="sales-cn">
                    <div class="row">
                        <div class="col-xs-6 col-md-4">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" title=""><img src="<?= base_url('images/places/nainital2.jpg') ?>" alt="" style="height: 300px;width: 100%"></a>
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" title=""><img src="<?= base_url('images/places/mussoorie.jpg') ?>" alt="" style="height: 300px;width: 100%"></a>
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" title=""><img src="<?= base_url('images/places/hemkund.jpg') ?>" alt="" style="height: 300px;width: 100%" ></a>
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" title=""><img src="<?= base_url('images/tour/home_stay.jpg') ?>" alt="" style="height: 300px;width: 100%"></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places" style="">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="sales-item">
                                <figure class="home-sales-img">
                                    <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" title=""><img src="<?= base_url('images/places/nainital3.jpg') ?>" alt="" style="height: 300px;width: 100%"></a>
                                    <figcaption>Save <span>30</span>%</figcaption>
                                </figure>
                                <div class="home-sales-text">
                                    <div class="home-sales-name-places" style="">
