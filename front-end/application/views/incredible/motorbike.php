                                ...
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><?= anchor( base_url('incredible_ukd'),'Tour Packages')?>
                                        <ul class="sub-menu"  >
                                            ...
                                            <li style=""  class="current-menu-parent"><?= anchor( base_url('incredible_ukd/motorbike'),'Motorbike Packages')?></li>
                       ...
                       <div class="row">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="post post-single">
                                    ...
                                    <br><br>
                                    <a href="#" class="awe-btn awe-btn-1 awe-btn-small" style="margin-left: 40%">Book My Tour</a>
                             </div>
