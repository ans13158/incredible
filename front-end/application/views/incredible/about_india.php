                            ...
                            <div class="tb-cell">
                                 <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><?= anchor( base_url('index.php/incredible_ukd/location'),'Location') ?>
                                        <ul class="sub-menu">
                                            <li class="current-menu-parent"><?= anchor( base_url('index.php/incredible_ukd/india'),'About India') ?></li>
                ...
                <div class="main-cn bg-white clearfix">
                    <section class="breakcrumb-sc">
                        <ul class="breadcrumb arrow">
                            ...
                            <li><a href="<?= base_url('index.php/incredible_ukd/ukdDestinations') ?>" title="">About India</a></li>
