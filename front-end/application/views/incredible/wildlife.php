                    ...
                    <section class="blog-content">
                       <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="post post-single">    
                                    ...
                                    <div class="post-content">
                                        <blockquote>
                                             <p>Walking is my main method of relaxation. I don't go over my lines or try to solve the world's problems, I just enjoy the scenery and the wildlife.

                                                <small>-Kevin Whately</small>
                                            </p>
                                        </blockquote>
                                        <br>
                                                    
                            <h3 style="color:#111">1. Jim Corbett National Park</h3>

                            <p>Jim Corbett National park is the oldest national park in India which got established in 1936 as Hailey National park and acts as a protected area of critically endangered Bengal Tiger of India.</p>
                           ...
                           <h2 class="title-single-content"></h2>
                            <p> <?=  img( ["src"=> base_url('images/tour/rajaji.jpg'),  "alt"=>"", "style"=>"height:350px;width:100%"] )  ?></p>
                                            
                            <h3 style="color:black">2. Rajaji National Park </h3>   

                            <p>Located in the Shivalik aranges of the Himalayas, the Rajaji National Park covers parts of three districts of Uttarakhand : Haridwar, Dehradun &amp; Pauri. In the year 2015, it's name was changed to Rajaji Tiger Reserve.</p>

                            <p> <strong>Flora at Rajaji National Park: </strong> the park contains tropical and subtropical moist broadleaf forests, in particular those of the Upper Gangetic Plains moist deciduous forests ecoregion. The forest ecosystems of the Park are quite varied and diverse. Plants such as shorea, mallotus, adina, terminalia, bridelia, dalbergia, acacia, syzygium and Phoebe are found in the Park.</p>
                            ...
                            <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" class="awe-btn awe-btn-1 awe-btn-small">Enquire Now</a>
                             ...
                             <h2 class="title-single-content"></h2>
                            <p> <?=  img( ["src"=> base_url('images/tour/asaan.jpg'),  "alt"=>"", "style"=>"height:350px;width:100%"] )  ?></p>
                                            
                            <h3 style="color:black">3. Assan Barrage Bird Sanctuary </h3>   

                            <p>The wetlands at Assan Barrage is located near the junction of two rivers : Yamuna &amp; Assan. The area hosts a large number of birds and waterfowls, many of which are listed as globally endangered by the IUCN Red Data Book. </p>

                            <p>Asan Barrage serves as a winter migration halt for trans-Himalayan migratory birds. These birds are spotted here on their way to southern India (in October-November) and again on their way back (in late February-March). By the end of October the Asan witnesses the arrival of migrants from Pale arctic region. <strong>The first to arrive is the shoveller followed by ruddy shelduck, mallard, coot, cormorant, egrets, wagtails, pond heron to name a few. Birds of prey like pallas fishing eagle, marsh harrier, greater spotted eagle, osprey and steppe eagle add to this magnificent diversity.</strong></p>
                            ...
                            <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" class="awe-btn awe-btn-1 awe-btn-small">Enquire Now</a>
                             ...
                             <h2 class="title-single-content"></h2>
                            <p> <?=  img( ["src"=> base_url('images/tour/nandaNational.jpg'),  "alt"=>"", "style"=>"height:350px;width:100%"] )  ?></p>
                            ...
                            <a href="<?= base_url('index.php/incredible_ukd/enquiry') ?>" class="awe-btn awe-btn-1 awe-btn-small">Enquire Now</a>
                             ...
                             <h2 class="title-single-content"></h2>
                            <p> <?=  img( ["src"=> base_url('images/tour/gangotri.jpg'),  "alt"=>"", "style"=>"height:350px;width:100%"] )  ?></p>
                                            
                            <h3 style="color:black">5.Gangotri National Park </h3>
                            <p>The Gangotri National Park,situated in the natural surrondings of Uttarkashi, is one of the highest-altitude located National Park &amp; falls under bio-geographical zone.
                            ...
                            <p>Within the Binsar Wildlife Sanctuary, 25 types of trees, 24 types of bushes and seven varieties of grasses are found. At the higher altitude, Binsar is dominated by the Oak and Rhododendron forests, while at the lower level, mostly you will find the Chir Pine forests.
