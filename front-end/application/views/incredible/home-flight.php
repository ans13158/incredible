<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/home-flight.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:49 GMT -->
                            ...
                            <div class="tb-cell">
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Flights</a>
                                        <ul class="sub-menu">
                                            <li class="current-menu-item"><a href="home-flight.html" title="">Flights</a></li>
                ...
                <div class="banner-cn">
                    ...
                    <div class="category-singer clearfix">
                        <div class="cate-singer-icon float-left">
                            <h2>Flight</h2><img src="images/icon-flight.png" alt=""></div>
            ...
            <div class="title-wrap">
                <div class="container">
                    <div class="travel-title float-left">
                        <h2>Last-Minute Cruise Deals: <span>Paris, Amsterdam, Saint Petersburg &amp; more</span></h2></div>
                </div>
            </div>
            <div class="container">
                <div class="cruise-deals-cn clearfix">
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">Amsterdam</a></div>
                                <div class="flight-price">One way fare only <span class="price">$50</span> depart from Paris</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">HongKong</a></div>
                                <div class="flight-price">Round trip fare only <span class="price">$258</span> depart from Hanoi</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">Marseille</a></div>
                                <div class="flight-price">One way fare only <span class="price">$50</span> depart from Shanghai</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            <figure class="flight-img">
                                <a href="#" title=""><img src="images/deal/img-8.jpg" alt=""></a>
                            </figure>
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">Barcelona</a></div>
                                <div class="flight-price">One way fare only <span class="price">$175</span> depart from Moscow</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">Bangkok</a></div>
                                <div class="flight-price">One way fare only <span class="price">$50</span> depart from Manila</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">Tokyo Haneda</a></div>
                                <div class="flight-price">One way fare only <span class="price">$150</span> depart from Taipei</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                <div class="flight-name"><a href="#" title="">San Francisco</a></div>
                                <div class="flight-price">One way fare only <span class="price">$214</span> depart from Washington</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/home-flight.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:50 GMT -->
