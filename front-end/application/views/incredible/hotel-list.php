<!DOCTYPE html>
<html>
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/hotel-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:27 GMT -->
                                ...
                                <ul class="menu-list text-uppercase">
                                    ...
                                    <li class="current-menu-parent"><a href="#" title="">Hotel</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="current-menu-item"><a href="hotel-list.html">Hotel List 1</a></li>
                            ...
                            <section class="hotel-list">
                                <div class="sort-view clearfix">
                                    <div class="sort-by float-left">
                                        <label>Sort by:</label>
                                        <div class="sort-select select float-left"><span data-placeholder="Select">Star rating</span>
                                            <select name="start">
                                        ...
                                        <div class="sort-select select float-left"><span data-placeholder="Select">Guest rating</span>
                                            <select name="guest">
                                        ...
                                        <div class="sort-select select float-left"><span data-placeholder="Select">Pricing</span>
                                            <select name="pricing">
                                    ...
                                    <div class="view-by float-right">
                                        <ul>
                                            <li>
                                                <a href="hotel-list.html" title="" class="current"><img src="images/icon-grid.png" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="hotel-list-2.html" title=""><img src="images/icon-list.png" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="hotel-maps.html" title=""><img src="images/icon-map.png" alt=""></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="hotel-grid-cn clearfix">
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.html" title="">Copley Square Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.html" title="">Grand Hotel Bagni Nuovi</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.html" title="">Melia White House Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.html" title="">A Hidden NYC Mystery Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="hotel-item">
                                            ...
                                            <div class="hotel-text">
                                                <div class="hotel-name"><a href="hotel-detail.html" title="">Town Hall Hotel</a></div>
                                                <div class="hotel-places"><a href="#" title="">Boston</a>, <a href="#" title="">Massachusetts</a></div>
                                                <hr class="hr">
                                                <div class="price-box"><span class="price old-price">From</span> <span class="price special-price">$175<small>/night</small></span></div>
                                            </div>
                            ...
                            <div class="sidebar-cn">
                                    ...
                                    <div class="row">
                                        <div class="form-search clearfix">
                                            ...
                                            <div class="form-field field-select col-md-6">
                                                <div class="select"><span>2 guest</span>
                                                    <select>
                                ...
                                <div class="widget-sidebar facilities-sidebar">
                                    ...
                                    <ul class="widget-ul">
                                        ...
                                        <li>
                                            <div class="radio-checkbox">
                                                <input id="facilities-2" type="checkbox" class="checkbox" checked="checked">
...
<!-- Mirrored from envato.megadrupal.com/html/bookawesome/hotel-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2017 13:29:29 GMT -->
